<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800 dark:text-gray200">
            {{ __('Todo') }}
        </h2>
    </x-slot>
    <div class="py-12">
                    ...
                    <form method="POST" action="{{ route('todo.store') }}">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <a href="{{ route('todo.index') }}"
                                class="inline-flex items-center px-4 py-2 text-xs fonstsemibold tracking-widest
...
focus:ring-indigo-500 focus:ring-ffset-2 dark:focus:ringoffset-gray-800
